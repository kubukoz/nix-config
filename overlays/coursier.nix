        ...
        , nixfmt
          ...
          in
            stdenv.mkDerivation rec {
              ...
              src = fetchurl {
                url =
                  "https://github.com/coursier/coursier/releases/download/v${version}/cs-x86_64-apple-darwin";
                sha256 = "sha256:007nmxxj4yik2m2199rmslxd9zq7xwm7sq455icy6xn4iklhb2i9";
              };
