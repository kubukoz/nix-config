  ...
  sources = {
    ...
    "clipboardy-3.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Su+uU5sr1jkUy1sGRpLKjKrvEOVXgSgiSInwa/qeID6aJ07yh+5NWc3h2QfjHjBnfX4LhtFcuAWKUsJ3r+fjbg==";
      };
    };
    "cross-spawn-7.0.3" = {
      name = "cross-spawn";
    ...
    "node-fetch-2.6.8" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "RZ6dBYuj8dRSfxpUSu+NsdF1dpPpluJxwOp+6IoDp/sH2QNDSvurYsAa+F1WxY2RjA1iP93xhcsUoYbF2XBqVg==";
      };
    };
    "npm-run-path-4.0.1" = {
      name = "npm-run-path";
...
in {
  dexsearch = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 =
        "R4ZbsezgMVvRXUgbGS2PLvCoXwsBRK4jKgOpcK6y/oL8FvdviaPHIy2Jx0gp+HmXm6d4mX8kcJAc0vY9w3d/aQ==";
    };
    dependencies = [
      sources."arch-2.2.0"
    ...
    meta = {
      description =
        "CLI that uses the Scaladex API to quickly search libraries and copy them to the clipboard";
